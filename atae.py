...
class lstmattention(object):
    def __init__(self,config,is_training,embeddingl,initializer):
        ...
        self.input_aspect=tf.placeholder(tf.int32,[None,self.aspectnum],name="input_aspect")    #batch*words,aspnums   
        self.aspectmask=tf.placeholder(tf.float32,[None,self.aspectnum],name="aspectmask")  #b*w,a
        ...
        #concate  atae
        self.inpute=tf.concat([self.inpute, self.aspect_final],2) #b,w,h*2
